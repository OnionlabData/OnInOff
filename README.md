...
1. Download the **OnInOff\_X.X.X.zip** file from the latest release
2. Extract the **OnInOff\_X.X.X.zip** file
3. Run **setup.exe**

## v1.3.5

* New Realsense SDK allows a larger camera variety
* Edit corner points workflow improved
